...
if ( ! function_exists( 'rosa2_lite_setup' ) ) {
	...
	function rosa2_lite_setup() {
		 ...
		 * to change 'rosa2-lite' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'rosa2-lite', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'primary'   => esc_html__( 'Primary Menu', 'rosa2-lite' ),
			'secondary' => esc_html__( 'Secondary Menu', 'rosa2-lite' ),
		) );
